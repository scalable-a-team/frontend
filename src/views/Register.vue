            ...
            <div class="g-0 lg:flex lg:flex-wrap">
                      ...
                      <div class="mb-4">
                        <label class="inline-flex items-center">
                          ...
                          <span class="ml-2 font-semibold"
                            >Register as a seller account</span
                          >
                        </label>
                      </div>
                    </div>
              ...
              >
                <div class="px-4 py-6 text-white md:mx-6 md:p-12">
                  ...
                  <p class="text-sm">
                    Printaverse mission is to provide a safe and easy to use
                    platform for object based printing. Our mediary service will
                    facilitate a trustworthy link between a client and supplier
                    to give both safety and security to both parties involved.
                    We aim to make object based printing more accessible to a
                    wider range of consumers and small businesses in order to
                    aid in growth and hobbies.
                  </p>
                </div>
              </div>
            </div>
  ...
  methods: {
    async createUser() {
      ...
      if (seller_account_type) {
        ...
        // use customer/register endpoints
        customerService
          .register(userMap)
          .then((register_response) => {
            const loginMap = {
